...
export default function NavigationEditor() {
    ...
    return (
        <div className="fixed inset-0 bg-base-100/95 backdrop-blur-sm z-[100] overflow-y-auto p-4 md:p-8">
            <div className="max-w-5xl mx-auto bg-base-100 shadow-2xl rounded-2xl border border-base-200 p-6">
